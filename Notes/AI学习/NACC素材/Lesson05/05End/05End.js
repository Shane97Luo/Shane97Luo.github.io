...
(lib.sun = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFF00").s().p("AlhFiQiSiTAAjPQAAjOCSiTQCTiSDOAAQDPAACTCSQCSCTAADOQAADPiSCTQiTCSjPAAQjOAAiTiSg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.sun, new cjs.Rectangle(-50,-50,100,100), null);
...
(lib.scrollinglandscape = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:0},29,cjs.Ease.linear).wait(1));

	// Layer 2
	this.instance_1 = new lib.mountains("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(1000,-101.2,1.25,1.286,0,0,0,800,76.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:0},29,cjs.Ease.linear).wait(1));
...
(lib.animatedsun = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.1,scaleY:1.1},47,cjs.Ease.linear).to({scaleX:1,scaleY:1},24,cjs.Ease.linear).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-60,-60,128,128);


// stage content:
(lib._06End = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// bird
	this.instance = new lib.bird_flight();
	this.instance.parent = this;
	this.instance.setTransform(308.9,184,0.318,0.318,0,0,0,342.2,342.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// landscape
	this.instance_1 = new lib.scrollinglandscape();
	this.instance_1.parent = this;
	this.instance_1.setTransform(1000,298.8,1,1,0,0,0,1000,-101.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// sky
	this.instance_2 = new lib.animatedsun();
	this.instance_2.parent = this;
	this.instance_2.setTransform(548.2,126.1);
...
// library properties:
lib.properties = {
	id: '5EE5D5E422CE4108A3E95CD6B2A076BC',
	width: 800,
	height: 400,
	fps: 30,
	color: "#FFFFFF",
...
an.compositions['5EE5D5E422CE4108A3E95CD6B2A076BC'] = {
