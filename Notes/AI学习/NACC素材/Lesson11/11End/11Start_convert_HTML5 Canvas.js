...
lib.ssMetadata = [
		{name:"12Start_convert_HTML5 Canvas_atlas_", frames: [[0,535,800,293],[0,830,443,289],[802,535,383,346],[1187,570,452,288],[0,0,1280,533],[445,883,473,212],[1187,860,386,56],[1282,0,536,568],[1641,570,294,416]]}
];
...
(lib.bottom_back = function() {
	this.spriteSheet = ss["12Start_convert_HTML5 Canvas_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib._12Start_convert_HTML5Canvas = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// title
	this.instance = new lib.movietitle();
	this.instance.parent = this;
	this.instance.setTransform(416,235.1,1,1,0,0,0,236.5,145.7);
...
// library properties:
lib.properties = {
	id: 'F177445AE23A481691A2EB7B57230011',
	width: 1280,
	height: 787,
	fps: 30,
	color: "#000000",
	opacity: 1.00,
	manifest: [
		{src:"images/12Start_convert_HTML5 Canvas_atlas_.png", id:"12Start_convert_HTML5 Canvas_atlas_"}
	],
	preloads: []
};
...
an.compositions['F177445AE23A481691A2EB7B57230011'] = {
